...
app.config['UPLOAD_FOLDER'] = "/Users/gaozhonghua/PycharmProjects/zibi-git/views/uploads"#1图片文件路径,绝对路径/Users/gaozhonghua/PycharmProjects/zibi-git/static/img/3
db = SQLAlchemy(app)
